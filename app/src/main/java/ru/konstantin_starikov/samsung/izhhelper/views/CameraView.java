package ru.konstantin_starikov.samsung.izhhelper.views;
...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void takePicture(final SaveImageListener saveFile) {
        ...
        if(camera != null) camera.takePicture(shutterCallback, rawCallback, new Camera.PictureCallback() {
            @Override
            public void onPictureTaken(byte[] data, Camera camera) {
                FileOutputStream outStream = null;
                try {
                    String Path = String.format(getContext().getApplicationInfo().dataDir + File.separator + "%d.jpg", System.currentTimeMillis());
